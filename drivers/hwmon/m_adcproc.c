...
#if defined(CONFIG_LGE_CHARGER_TEMP_SCENARIO) && !defined(CONFIG_LGE_PM_CAYMAN_VZW)
...
#elif defined(CONFIG_LGE_CHARGER_TEMP_SCENARIO) && defined(CONFIG_LGE_PM_CAYMAN_VZW)
const struct adc_map_pt adcmap_batttherm[THERM_LAST] = {
	{1781,  -20},
	{1561,	-10},
	{1465,	 -5},
...
const struct adc_map_pt adcmap_batttherm_ta[THERM_LAST] = {
	{1793,  -20},
	{1573,	-10},
	{1477,	 -5},
	{1300,    5},
				...
				struct adc_chan_result *adc_chan_result)
{
	...
	if (is_chg_plugged_in()) {
		return adc_map_linear(
			adcmap_batttherm_ta,
			sizeof(adcmap_batttherm_ta)/sizeof(adcmap_batttherm_ta[0]),
