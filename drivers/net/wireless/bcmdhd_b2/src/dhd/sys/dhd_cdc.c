 ...
 *
 * $Id: dhd_cdc.c 313885 2012-02-09 03:55:26Z $
 *
...
/*LGE_CHANGE_S, [WiFi][jaeoh.oh@lge.com], 2012-04-27, Fix KT QOS CONTROL FIELD */
#ifdef CONFIG_MACH_LGE_120_BOARD_KT
#include <proto/bcmip.h>
#include <proto/ethernet.h>
#endif
/*LGE_CHANGE_E, [WiFi][jaeoh.oh@lge.com], 2012-04-27, Fix KT QOS CONTROL FIELD */
...
#if defined(CONFIG_HAS_EARLYSUSPEND)	/* LGE_patch : config file setting */
int
#else
static int
