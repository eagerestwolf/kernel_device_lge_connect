...
/*			pr_info("NXP:%s() Rx_timestamp Avail=[%5lu] Secs=[%10lu] nSecs=[%9lu] num_bufs_acked(%lu) bytes_written(%lu) at %d in pcm_out.c\n", \
...
/*
		pr_info("NXP: %s(): Rx_timestamp Avail=[%5lu] Secs=[%6lu] nSecs=[%9lu] bytes_written(%lu) num_bufs_acked(%lu) at %d in qdsp6v2/pcm_out.c\n", \
				__func__, pcm->tstamp.avail, pcm->tstamp.time.tv_sec, pcm->tstamp.time.tv_nsec, pcm->bytes_written, pcm->num_bufs_acked, __LINE__);
*/
/* Copyright 2011 NXP Software, end */
#endif
...
/* Copyright 2011 NXP Software, begin */
	...
	{
//		pr_info("NXP: %s(): cmd(AUDIO_PCM_HTIMESTAMP) at %d in qdsp6v2/pcm_out.c\n", __func__, __LINE__);
...
//	pr_info(" NXP: %s(): count(%d) sample_rate(%d) bytes_written(%lu) at %d in qdsp6v2/pcm_out.c\n", __func__, count, pcm->sample_rate, pcm->bytes_written, __LINE__);
