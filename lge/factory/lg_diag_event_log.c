...
static int __devexit diag_event_log_remove(struct platform_device *pdev)
{
...
static int __devinit diag_input_init(void)
{
	return platform_driver_register(&diag_input_driver);
}


static void __devexit diag_input_exit(void)
{
