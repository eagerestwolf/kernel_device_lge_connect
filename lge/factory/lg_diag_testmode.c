...
#if defined(CONFIG_MACH_LGE_I_BOARD_VZW) || defined(CONFIG_MACH_LGE_C1_BOARD_MPS)	// [LG_BTUI] '12.05.07 : LG_BTUI_TEST_MODE For VZW
...
#if defined(CONFIG_MACH_LGE_120_BOARD) || defined(CONFIG_MACH_LGE_I_BOARD_VZW)
int g_sd_status = 0;
#define EXT_SD_WR_TEST_FILE   "/_ExternalSD/SDTest.txt"
#define EXT_SD_MOUNT_POINT   "/_ExternalSD"
#else
...
#if 0// defined(CONFIG_MACH_LGE_I_BOARD_VZW) || defined(CONFIG_MACH_LGE_C1_BOARD_MPS)
...
void* LGF_TestScriptItemSet(test_mode_req_type * pReq, DIAG_TEST_MODE_F_rsp_type * pRsp)
{
    ...
    switch(pReq->test_mode_test_scr_mode)
    {
        case TEST_SCRIPT_ITEM_SET:
            ...
            #if defined(CONFIG_MACH_LGE_120_BOARD) || defined(CONFIG_MACH_LGE_I_BOARD_VZW) || defined(CONFIG_MACH_LGE_C1_BOARD_MPS)
            send_to_arm9((void*)&req_ptr, (void*)pRsp);
...
#if defined(CONFIG_MACH_LGE_I_BOARD_VZW) || defined(CONFIG_MACH_LGE_C1_BOARD_MPS)	//diag
