...
/* LGE_S daheui.kim@lge.com parsing kcal from cmdline */
...
//	KEY(2, 1, KEY_PTN_UNLOCK),  // 2012.04.17 deukgi.shin@lge.com To prevent pattern unlock key from side key [S] 
...
/* [LGE_CHANGE] change key led backlight(2->1), lee.sangchul@lge.com, 2011-0903 */
/* [LGE_CHANGE] change key led backlight(1->2), lee.soouk@lge.com, 2011-0910 , requirement  from H/W*/	
/* [LGE_CHANGE] change key led backlight(2->1), daheui.kim@lge.com, 2011-1115 , requirement  from H/W*/	
		.max_brightness = 1,
