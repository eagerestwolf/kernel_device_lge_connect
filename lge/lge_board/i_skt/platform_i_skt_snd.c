...
#if defined (CONFIG_MACH_LGE_120_BOARD_SKT)
#include "timpani_profile_8x60_cayman_skt.h"
#elif defined (CONFIG_MACH_LGE_120_BOARD_KT)
#include "timpani_profile_8x60_cayman_kt.h"
#else
#include "timpani_profile_8x60_i_skt.h"
#endif
...
static wmCodecCmd seq_lin_to_headset_spkout[] = 
{
    ...
    {0x30, 0x0000},	
#ifdef CONFIG_MACH_LGE_120_BOARD
	{0x1C, 0x0117}, //refer to page 26
	{0x1D, 0x0117}, //refer to page 26	  
#else
...
#ifdef LVVE	// 20111220, mikyoung.chang@lge.com, KT CSVT Device
static struct adie_codec_action_unit iearpiece_csvt_48KHz_osr256_actions[] =
	HANDSET_RX_MONO_8000_OSR_256_CSVT;

static struct adie_codec_hwsetting_entry iearpiece_csvt_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = iearpiece_csvt_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(iearpiece_csvt_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile iearpiece_csvt_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = iearpiece_csvt_settings,
	.setting_sz = ARRAY_SIZE(iearpiece_csvt_settings),
};

static struct snddev_icodec_data snddev_csvt_handset_rx_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "handset_csvt_rx",
	.copp_id = 0,
	.profile = &iearpiece_csvt_profile,
	.channel_mode = 1,
	.default_sample_rate = 48000,
};

static struct platform_device msm_csvt_handset_rx_device = {
	.name = "snddev_icodec",
	.dev = { .platform_data = &snddev_csvt_handset_rx_data },
};
#endif
...
#ifdef LVVE	// 20111220, mikyoung.chang@lge.com, KT CSVT Device
static struct adie_codec_action_unit imic_csvt_48KHz_osr256_actions[] =
	HANDSET_TX_PRI_MONO_OSR_256_CSVT;

static struct adie_codec_hwsetting_entry imic_csvt_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = imic_csvt_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(imic_csvt_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile imic_csvt_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = imic_csvt_settings,
	.setting_sz = ARRAY_SIZE(imic_csvt_settings),
};

static struct snddev_icodec_data snddev_csvt_handset_tx_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "handset_csvt_tx",
	.copp_id = 1,
	.profile = &imic_csvt_profile,
	.channel_mode = 1,
	.default_sample_rate = 48000,
	.pamp_on = msm_snddev_enable_amic_power,
	.pamp_off = msm_snddev_disable_amic_power,
...
static struct platform_device msm_csvt_handset_tx_device = {
	.name = "snddev_icodec",
	.dev = { .platform_data = &snddev_csvt_handset_tx_data },
};
#endif
...
#ifdef LVVE	// 20111220, mikyoung.chang@lge.com, KT CSVT Device
static struct adie_codec_action_unit ihs_stereo_csvt_48KHz_osr256_actions[] =
#ifdef CONFIG_LGE_AUDIO_NO_NCP_MODE
	HEADSET_RX_STEREO_AB_LEG_CSVT;
#else
	HEADSET_AB_CPLS_48000_OSR_256;
#endif

static struct adie_codec_hwsetting_entry ihs_stereo_rx_csvt_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = ihs_stereo_csvt_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(ihs_stereo_csvt_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile ihs_stereo_rx_csvt_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = ihs_stereo_rx_csvt_settings,
	.setting_sz = ARRAY_SIZE(ihs_stereo_rx_csvt_settings),
};

static struct snddev_icodec_data snddev_csvt_headset_rx_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "headset_stereo_csvt_rx",
	.copp_id = 0,
	.profile = &ihs_stereo_rx_csvt_profile,
	.channel_mode = 2,
	.default_sample_rate = 48000,
/* LGE_CHANGE 2011. 01. 20 sungwoo.cho, dongsung.shin start */
#ifdef CONFIG_LGE_AUDIO_AMP_WM9093
...
static struct platform_device msm_csvt_headset_rx_device = {
	.name = "snddev_icodec",
	.dev = { .platform_data = &snddev_csvt_headset_rx_data },
};
#endif
...
#ifdef LVVE	// 20111220, mikyoung.chang@lge.com, KT CSVT Device
static struct adie_codec_action_unit ispkr_stereo_csvt_48KHz_osr256_actions[] =
	SPEAKER_RX_STEREO_48000_OSR_256_CSVT;

static struct adie_codec_hwsetting_entry ispkr_stereo_csvt_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = ispkr_stereo_csvt_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(ispkr_stereo_csvt_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile ispkr_stereo_csvt_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = ispkr_stereo_csvt_settings,
	.setting_sz = ARRAY_SIZE(ispkr_stereo_csvt_settings),
};

static struct snddev_icodec_data snddev_csvt_speaker_rx_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "speaker_stereo_csvt_rx",
	.copp_id = 0,
	.profile = &ispkr_stereo_csvt_profile,
	.channel_mode = 2,
	.default_sample_rate = 48000,
	.pamp_on = msm_snddev_poweramp_on_spk,
	.pamp_off = msm_snddev_poweramp_off_spk,
...
static struct platform_device msm_csvt_speaker_rx_device = {
	.name = "snddev_icodec",
	.dev = { .platform_data = &snddev_csvt_speaker_rx_data },
};
#endif
...
#ifdef LVVE	// 20111220, mikyoung.chang@lge.com, KT CSVT Device
static struct adie_codec_action_unit submic_csvt_48KHz_osr256_actions[] =
	AUXIN_MONO_OSR_256_CSVT;

static struct adie_codec_hwsetting_entry submic_csvt_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = submic_csvt_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(submic_csvt_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile submic_csvt_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = submic_csvt_settings,
	.setting_sz = ARRAY_SIZE(submic_csvt_settings),
};

static struct snddev_icodec_data snddev_csvt_speaker_tx_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "speaker_mono_csvt_tx",
	.copp_id = 1,
#ifdef CONFIG_LGE_AUDIO_USE_AUXMIC_FOR_SPEAKER_MODE
	.profile = &submic_csvt_profile,
#else
	.profile = &imic_csvt_profile,
#endif
	.channel_mode = 1,
...
static struct platform_device msm_csvt_speaker_tx_device = {
	.name = "snddev_icodec",
	.dev = { .platform_data = &snddev_csvt_speaker_tx_data },
};
#endif
...
#ifdef LVVE	// 20111220, mikyoung.chang@lge.com, KT CSVT Device
static struct adie_codec_action_unit iheadset_mic_tx_csvt_osr256_actions[] =
	HEADSET_TX_MONO_PRI_OSR_256_CSVT;

static struct adie_codec_hwsetting_entry iheadset_mic_tx_csvt_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = iheadset_mic_tx_csvt_osr256_actions,
		.action_sz = ARRAY_SIZE(iheadset_mic_tx_csvt_osr256_actions),
	}
};

static struct adie_codec_dev_profile iheadset_mic_csvt_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = iheadset_mic_tx_csvt_settings,
	.setting_sz = ARRAY_SIZE(iheadset_mic_tx_csvt_settings),
};

static struct snddev_icodec_data snddev_csvt_headset_tx_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "headset_mono_csvt_tx",
	.copp_id = PRIMARY_I2S_TX,
	.profile = &iheadset_mic_csvt_profile,
	.channel_mode = 1,
	.default_sample_rate = 48000,
};

static struct platform_device msm_csvt_headset_tx_device = {
	.name = "snddev_icodec",
	.dev = { .platform_data = &snddev_csvt_headset_tx_data },
};
#endif
...
#ifdef LVVE	// 20111220, mikyoung.chang@lge.com, KT CSVT Device
static struct snddev_ecodec_data snddev_csvt_bt_sco_rx_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "bt_sco_csvt_rx",
	.copp_id = PCM_RX,
	.channel_mode = 1,
...
static struct snddev_ecodec_data snddev_csvt_bt_sco_tx_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "bt_sco_csvt_tx",
	.copp_id = PCM_TX,
	.channel_mode = 1,
...
struct platform_device msm_csvt_bt_sco_rx_device = {
	.name = "msm_snddev_ecodec",
	.dev = { .platform_data = &snddev_csvt_bt_sco_rx_data },
};

struct platform_device msm_csvt_bt_sco_tx_device = {
	.name = "msm_snddev_ecodec",
	.dev = { .platform_data = &snddev_csvt_bt_sco_tx_data },
};
#endif
...
#ifdef LVVE	// 20111220, mikyoung.chang@lge.com, KT CSVT Device
	&msm_csvt_handset_rx_device,
	&msm_csvt_handset_tx_device,
	&msm_csvt_headset_rx_device,
	&msm_csvt_headset_tx_device,
	&msm_csvt_speaker_rx_device,
	&msm_csvt_speaker_tx_device,
	&msm_csvt_bt_sco_rx_device,
	&msm_csvt_bt_sco_tx_device,
#endif
};
