...
wmCodecCmd seq_lin_to_spkout_playback[] = 
{
    ...
    {0x22, 0x0000}, // 0dB
    {0x03, 0x0108},  
    {0x25, 0x0168}, //0x0170  // 12dB(178}, 9dB(170}, 7.5dB(168}, 6dB(160}, 4.5dB(158}, 3dB(150}, 1.5dB(148}, 0dB(140)
    {0x26, 0x013C}, // refer page 26  
    {0x17, 0x0000},  
    {0x01, 0x100B}
};
...
wmCodecCmd seq_lin_to_spkout_vzwnavi[] = 
{
    ...
    {0x22, 0x0000}, // 0dB
    {0x03, 0x0108},  
    {0x25, 0x0168}, // 12dB(178}, 9dB(170}, 7.5dB(168}, 6dB(160}, 4.5dB(158}, 3dB(150}, 1.5dB(148}, 0dB(140)
    {0x26, 0x013F}, // refer page 26  
    {0x17, 0x0000},  
    {0x01, 0x100B}
};
